...
if [[ ${TAGS[@]} =~ "pxeserve" ]]; then
    ...
    cp -a /run/archiso/bootmnt/arch/x86_64/airootfs.sfs ${MOUNTPOINT%%/}/srv/pxe/arch/x86_64/pxeboot.img
    ...
    chown -R root:root ${MOUNTPOINT%%/}/srv/tftp ${MOUNTPOINT%%/}/srv/pxe
    find ${MOUNTPOINT%%/}/srv/tftp ${MOUNTPOINT%%/}/srv/pxe -type d -exec chmod 755 {} \;
    find ${MOUNTPOINT%%/}/srv/tftp ${MOUNTPOINT%%/}/srv/pxe -type f -exec chmod 644 {} \;
fi
